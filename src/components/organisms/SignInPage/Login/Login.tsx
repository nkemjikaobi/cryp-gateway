...
const Login = () => {
  ...
  return (
    <>
      <div className="bg-white pt-[40px] px-[75px] pb-[61px] w-[736px] mx-auto mt-[57px] rounded-[50px] shadow-auth">
        <h3 className="text-20 font-semibold">Nice to have you back @Adedam0la!</h3>
        <div className="flex items-center mt-[37px] mb-[57px] text-18 font-medium">
        ...
        <div className="flex flex-col space-y-[51px] justify-center items-center">
          <CustomButton
        ...
        <div className="mt-[34px] flex items-center justify-between">
          {SocialsData.map((social) => (
            <div className="flex items-center justify-center space-x-2 cursor-pointer rounded-[10px] w-[242px] h-[60px] border border-glass-450" key={social.id}>
